...
function App() {
    ...
    return (<main class="shell">
      ...
      <button class="importHandle" type="button" aria-controls="import-panel" aria-expanded={isImportPanelOpen()} onClick={() => setIsImportPanelOpen((open) => !open)}>
        {isImportPanelOpen() ? 'Close imports' : 'Imports'}
      </button>

      <aside id="import-panel" class="sidePanel" classList={{ open: isImportPanelOpen() }} aria-label="Import controls">
        <div class="brand">
          <h1>tileme</h1>
